package com.api.moments.services.aws;
...
public class AwsService {
  ...
  public String upload(MultipartFile multipartFile, String fileName) throws Exception {
    ...
    try {
      ...
      amazonS3.putObject(
          new PutObjectRequest("moments-bucket", fileName, fileConverted).withCannedAcl(
              CannedAccessControlList.PublicRead));

      fileUri = "http://s3.localhost.localstack.cloud:4566/moments-bucket" + "/" + fileName;
